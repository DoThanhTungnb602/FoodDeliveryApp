...
public class MockData {
    ...
    public MockData() {
        ...
        // foods.add(new Food("Bánh mì", "Bánh mì thịt nướng", 20000, true, 10, 1, 4, 1,
        // foodImages1));
        // foods.add(new Food("Nước tăng lực", "Nước tăng lực có gas", 12000, true, 15,
        // 2, 4.2f, 1, foodImages2));
        // foods.add(new Food("Cà phê", "Cà phê đen", 15000, true, 20, 3, 4.5f, 1,
        // foodImages3));
        // foods.add(new Food("Bánh mì", "Bánh mì thịt nướng", 20000, true, 10, 1, 4, 1,
        // foodImages4));
        // foods.add(new Food("Nước tăng lực", "Nước tăng lực có gas", 12000, true, 15,
        // 2, 4.2f, 1, foodImages5));
        // foods.add(new Food("Cà phê", "Cà phê đen", 15000, true, 20, 3, 4.5f, 1,
        // foodImages6));
        // foods.add(new Food("Bánh mì", "Bánh mì thịt nướng", 20000, true, 10, 1, 4, 1,
        // foodImages7));
        // foods.add(new Food("Nước tăng lực", "Nước tăng lực có gas", 12000, true, 15,
        // 2, 4.2f, 1, foodImages8));
        // foods.add(new Food("Cà phê", "Cà phê đen", 15000, true, 20, 3, 4.5f, 1,
        // foodImages9));
        // foods.add(new Food("Bánh mì", "Bánh mì thịt nướng", 20000, true, 10, 1, 4, 1,
        // foodImages10));
